...
function NFTDropPage() {
  ...
  return (
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
      ...
      {/* Left */}
      <div className="lg:col-span-4 bg-gradient-to-br from-blue-600 to-rose-500">
        <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
          ...
          <div className="text-center p-5 space-y-2">
            ...
            <h2 className="text-xl text-gray-300">
              A collection of PAPAFAM Apes who lives and breath React
            </h2>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        {/* Mint Button */}
        <button className="h-16 w-full mt-10 bg-gradient-to-bl bg-red-400 hover:bg-red-500 active:bg-red-600  text-white font-bold rounded-full">
          Mint NFT (0.01 ETH)
        </button>
      </div>
    </div>
